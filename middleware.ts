...
export function middleware(req: NextRequest) {
  ...
  if (pathname.startsWith("/api/") && ["POST","PUT","DELETE","PATCH"].includes(req.method) && !pathname.startsWith("/api/payment/callback") && !pathname.startsWith("/api/chat") && !pathname.startsWith("/api/admin/verify")) {
